<script lang="ts">
    export let directionIsUp = true;
    export let handleClick: (e, down?: boolean) => void;
    export let rulerId: string;
</script>

<div
    class="button_container"
    id={directionIsUp ? "top_button_container" : "bottom_button_container"}
